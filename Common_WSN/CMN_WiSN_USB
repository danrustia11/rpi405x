...
#********************************#
#********************************#
#   Common platform WiSN USB     #
#   by: Dan Jeric Arcega Rustia  #
#                                #
#   Log:                         #
#   8/16/2017 - added averaging  #
#               filter and timer #
            ...
            try:
               ...
               # print(read1)
                if len(read1) > 10:
                    ...
                    temp_samples[samples]=float(temp)
                    hum_samples[samples]=float(hum)
            except:
                pass
